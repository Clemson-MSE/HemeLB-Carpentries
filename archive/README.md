This README file, along with the directory in which it sits will be deleted by the end time of this project. 

The purpose of this directory is to archive the LAMMPS episodes that already exist in this repo as of 12/05/21, so as 
the format and requirements therein can be preserved whilst keeping the local
[_episodes](https://github.com/HemeLB-dev/HemeLB-Carpentries/tree/gh-pages/_episodes) directory clean for fresh material

The lesson outline for LAMMPS for each episode is discussed below;

[01-why-bother-with-performance.md:](01-why-bother-performance.md): Brief notes
...
* [02-benchmark-and-scaling.md: How do I benchmark software performance in HPC?](02-hardware-performance.md):
...
* [03-acceleration.md: Can I accelerate performance?](03-benchmark-and-scaling.md):brief
...
* [04-lammps-bottlenecks.md: Identifying bottlenecks in LAMMPS](04-lammps-bottlenecks.md):
...
* [05-accelerating-lammps.md: How can I accelerate LAMMPS performance?](05-accelerating-lammps.md):
...
* [06-invoking-kokkos.md: How do I invoke KOKKOS in LAMMPS?](06-invoking-kokkos.md):
  technical aspects to use KOKKOS with LAMMPS
    * Transition from regular LAMMPS call to accelerated call

* [07-kokkos-openmp.md: Compare KOKKOS/OpenMP performance with regular LAMMPS/OpenMP performance](07-kokkos-openmp.md):
...
* [08-kokkos-gpu.md: Compare KOKKOS/GPU performance with regular LAMMPS/GPU performance](08-kokkos-gpu.md):
...
* [09-limitations.md: What are the limitatations of different accelerator packages?](09-limitations.md):
